    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .searchDictionary)) { notification in
            ...
            if isKorean {
                ...
                currentURL = makeSearchURL(for: trimmed, dicType: targetTab.dicCode)
            } else {
                ...
                currentURL = makeSearchURL(for: trimmed, dicType: selectedDic.dicCode)
            }
        }
